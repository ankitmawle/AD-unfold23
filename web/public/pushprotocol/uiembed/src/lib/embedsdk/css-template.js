...
function default_1(config) {
    ...
    const rootID = (0, helpers_1.getRootID)(config);
    return `
        ...
        #${rootID}.epns-sdk-embed-modal.epns-sdk-embed-modal-open {
          ...
          right: 0;
          bottom: 0;
          z-index: ${constants_1.default.EPNS_SDK_EMBED_CSS_ZINDEX_MAX - 2};
        }
        ...
        #${rootID} .epns-sdk-embed-modal-content {
          ...
          width: 100%;
          height: 100%;
          z-index: ${constants_1.default.EPNS_SDK_EMBED_CSS_ZINDEX_MAX};
        }

        #${rootID} .epns-sdk-embed-modal-content iframe#${constants_1.default.EPNS_SDK_EMBED_IFRAME_ID} {
...
//# sourceMappingURL=css-template.js.map